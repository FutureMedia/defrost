 ...
 * defrost/footer-three-columns-contrast-background
 * Categories: footer
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'fmedia' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'fmedia' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'fmedia' ); ?></a></p>
<!-- /wp:paragraph -->
