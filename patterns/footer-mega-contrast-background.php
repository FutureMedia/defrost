 ...
 * defrost/footer-mega-contrast-background
 * Categories: footer
...
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( 'With its clean, minimal design and powerful feature set, Defrost enables agencies to build stylish and sophisticated WordPress websites.', 'fmedia' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
